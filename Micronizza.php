...
$fileNames = [
	'src/componenti/reset.css',
	'src/componenti/variabili.css',
	'src/componenti/layout.css',
	'src/componenti/tipografia.css',
	'src/componenti/navigazione.css',
	'src/componenti/form.css',
	'src/componenti/table.css',
	'src/componenti/button.css',
	'src/componenti/dialog.css',
	'src/componenti/details.css',
	'src/componenti/media.css'
];

$utilita = ['src/componenti/utilita.css'];

$cssMinifier = new Micronizza($fileNames);
